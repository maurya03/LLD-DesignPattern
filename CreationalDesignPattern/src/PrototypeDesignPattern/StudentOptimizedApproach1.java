...
public class StudentOptimizedApproach1 {
    ...
    public StudentOptimizedApproach1(){}
    public StudentOptimizedApproach1(String name, int age, String batch, String instName)
    {
        this.name = name;
        this.age = age;
        this.batch = batch;
